    ...
    public class PluginAdditionalConfigConfig : BaseEntityConfig<PluginAdditionalConfig>
    {
        public override void Configure(EntityTypeBuilder<PluginAdditionalConfig> builder)
        {
            ...
            builder.HasData(
                ...
                new PluginAdditionalConfig { Id = 12, PluginId = 6, Name = "Region", Label = "Region", Type = "string", IsRequired = false, IsSecret = false, Created = new DateTime(2018, 9, 28, 7, 23, 37, 58, DateTimeKind.Utc), ConcurrencyStamp = "c48cafcc-b3e9-4375-a2c2-f30404382264" },
                new PluginAdditionalConfig { Id = 13, PluginId = 6, Name = "AppServicePlan", Label = "App Service Plan", Type = "string", IsRequired = false, IsSecret = false, Created = new DateTime(2018, 9, 28, 7, 23, 37, 58, DateTimeKind.Utc), ConcurrencyStamp = "c48cafcc-b3e9-4375-a2c2-f30404382265" }
            );
        }
    }
}
