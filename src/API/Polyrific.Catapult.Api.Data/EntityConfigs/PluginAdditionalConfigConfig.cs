    ...
    public class PluginAdditionalConfigConfig : BaseEntityConfig<PluginAdditionalConfig>
    {
        public override void Configure(EntityTypeBuilder<PluginAdditionalConfig> builder)
        {
            ...
            builder.HasData(
                ...
                new PluginAdditionalConfig { Id = 10, PluginId = 6, Name = "IsAllowRename", Label = "Allow Rename?", Type = "boolean", Hint = "Allows Automatically reassign app service name when it is not available?", IsRequired = false, IsSecret = false, Created = new DateTime(2018, 9, 28, 7, 23, 37, 58, DateTimeKind.Utc), ConcurrencyStamp = "c48cafcc-b3e9-4375-a2c2-f30404382266" },
