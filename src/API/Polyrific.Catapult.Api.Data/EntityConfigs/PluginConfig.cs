...
namespace Polyrific.Catapult.Api.Data.EntityConfigs
{
    public class PluginConfig : BaseEntityConfig<Plugin>
    {
        public override void Configure(EntityTypeBuilder<Plugin> builder)
        {
            ...
            builder.HasData(
                new Plugin { Id = 1, Name = "Polyrific.Catapult.TaskProviders.AspNetCoreMvc", Type = "GeneratorProvider", Author = "Polyrific", Version = "1.0.0-beta2", Created = new DateTime(2018, 9, 28, 7, 23, 37, 58, DateTimeKind.Utc), ConcurrencyStamp = "976e0533-360a-4e46-8220-7c1cfdf0e0a1" },
