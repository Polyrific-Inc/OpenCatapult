    ...
    public class ExternalServiceTypeConfig : BaseEntityConfig<ExternalServiceType>
    {
        public override void Configure(EntityTypeBuilder<ExternalServiceType> builder)
        {
            ...
            builder.HasData(
                ...
                new ExternalServiceType { Id = 3, Name = "GenericService", Created = new DateTime(2018, 9, 19, 8, 14, 52, 51, DateTimeKind.Utc), ConcurrencyStamp = "2425fe0d-4e3e-4549-a9a7-60056097ce98" }
            );
        }
    }
}
