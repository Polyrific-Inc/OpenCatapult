...
namespace Polyrific.Catapult.Engine.Core.JobTasks
{
    ...
    {
        public TestTask(IProjectService projectService, IProjectDataModelService dataModelService, IExternalServiceService externalServiceService, ILogger<TestTask> logger) 
