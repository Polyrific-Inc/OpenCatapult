...
namespace Polyrific.Catapult.Engine.UnitTests.Core.JobTasks
{
    public class BuildTaskTests
    {
        ...
        public async void RunMainTask_Success()
        {
            ...
            var task = new BuildTask(_projectService.Object, _projectDataModelService.Object, _externalServiceService.Object , _logger.Object) {BuildProviders = providers};
        ...
        public async void RunMainTask_NoProvider()
        {
            ...
            var task = new BuildTask(_projectService.Object, _projectDataModelService.Object, _externalServiceService.Object , _logger.Object);
            task.SetConfig(config, "working");
            task.Provider = "FakeBuildProvider";
